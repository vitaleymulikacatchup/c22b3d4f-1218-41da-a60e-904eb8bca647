...
export const metadata: Metadata = {
  title: "Cosmic Journeys - Space Tourism & Galaxy Travel",
  description: "Book your journey to the stars. Exclusive space travel experiences from Earth orbit to lunar landings.",
  keywords: "space tourism, space travel, cosmic journeys, lunar landing, orbital flight, space adventure",
  metadataBase: new URL("https://cosmic-journeys.com"),
  alternates: {
    canonical: "https://cosmic-journeys.com"
  },
  openGraph: {
    title: "Cosmic Journeys - Space Tourism & Galaxy Travel",
    description: "Experience the universe like never before. Book your journey to the stars today.",
    siteName: "Cosmic Journeys",
    type: "website",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764607018789-6pkdv8h7.jpg",
      alt: "Earth from space"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Cosmic Journeys - Space Tourism",
    description: "Book your exclusive space travel experience today",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_32SgGlSmvaVv2SYOkECykbr8Q49/uploaded-1764607018789-6pkdv8h7.jpg"]
  },
  robots: {
    index: true,
    follow: true
